...
### Installation
```
go get -u github.com/meetup/dsio
```
...
### File format and Samples:
 - [CSV and TSV format](https://github.com/meetup/dsio/wiki/CSV-and-TSV-Format)
 - [YAML format](https://github.com/meetup/dsio/wiki/YAML-Format)
